...
/**
 * {@link CrazyLambdas_done} is an exercise class. Each method returns a functional interface and it should be implemented
 ...
 */
public class CrazyLambdas_done {
    ...
    public static BiFunction<Map<String, IntUnaryOperator>, String, IntUnaryOperator> functionLoader() {
        return (Map<String, IntUnaryOperator> map, String s) -> map.get(s) != null ? map.get(s) : IntUnaryOperator.identity();
    }
